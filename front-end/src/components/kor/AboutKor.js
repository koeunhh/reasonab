...
export default class AboutKor extends Component {
  render(){    
    return(
      <div className='about'>
        <h3>아는만큼 보는 알다는 각 전공별 엄선된 튜터 중심으로 1대 5미만의 소수 정예 수업을 진행합니다.</h3>
        <ul>
          <li>기초 테크닉</li> 
          <li>그래픽 디자인</li>
          <li>애니메이션/일러스트레이션</li>
        ...
        <h3>아는 만큼 보이는 알다에서 더 멀리, 더 높이 미래를 꿈꾸는 학생들을 기다립니다</h3>
      </div>
    )
  }
}